...
const SingleProducts = () => {
  ...
  return (
    <div className="mt-28 max-w-screen-2xl mx-auto xl:px-28 px-4 ">
      <div className="p-3 max-w-7xl m-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-6 h-max">
            ...
            <div>
              ...
              <p className="mt-3 text-gray-600 text-base leading-6 text-justify sm:text-left sm:mt-4">
                ...
                totam! Ad doloribus necessitatibus debitis maiores modi, fugiat
                nulla quos cumque. Recusandae porro, magni delectus laborum
                corrupti repellendus sit libero? Dolor!
              </p>
        ...
        <div className="text-black/75 mt-12">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas, exercitationem voluptatum, ad aspernatur maiores recusandae at ratione eos temporibus suscipit fugiat. Asperiores velit pariatur assumenda. Dolore, sapiente consectetur vel, repellendus provident officia sed dolores sint impedit facere et ratione facilis culpa libero molestias hic tempore nesciunt non ducimus repellat enim.</p>
        </div>
      </div>
    </div>
  );
