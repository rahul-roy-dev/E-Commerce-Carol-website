    ...
    <div className='bg-[#1E2832] bg-opacity-5 xl:px-28 px-4 py-16'>
        ...
        <div>
            ...
            <form className='md:w-1/2 mx-auto text-center'>
                <input type="email" name="email" id="email" placeholder="Email address..." className='bg-transparent outline-none border-b-2 pl-2 border-black md:w-2/3 w-full mb-5 placeholder:text-black/50 mr-4' />
